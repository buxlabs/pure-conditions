...
equal(isIn(3, [1, 2 ,3, 4]), true)
equal(isIn('5', '12345'), true)
...
equal(isPhone('312321321aaa'), false)
equal(isPhone('12345'), false)
equal(isPhone('1234567891011'), false)
equal(isPhone('12345678910112312321321'), false)
equal(isPhone('32  267 70 41'), false)
equal(isPhone('32  267  70  41'), false)
equal(isPhone('3 2 267 70 41'), false)
equal(isPhone('(541) 754-3010'), true)
equal(isPhone('444-555-1234'), true)
