...
deepStrictEqual(isEmpty({}), true)
deepStrictEqual(isEmpty(function () {}), true)
...
deepStrictEqual(isEmpty(new Map([['foo', 1], ['bar', 2]])), false)
...
deepStrictEqual(isObject(function () {}), true)
...
deepStrictEqual(isSoonerThan(new Date(2018, 4, 1), new Date(2018, 4, 11)), true)
deepStrictEqual(isSoonerThan(new Date(2018, 4, 11), new Date(2018, 4, 1)), false)
...
deepStrictEqual(isLaterThan(new Date(2018, 4, 1), new Date(2018, 4, 11)), false)
...
deepStrictEqual(isTabletTest(), false)
...
delete require.cache[require.resolve('./isTablet')]
const isTabletTest2 = require('./isTablet')
deepStrictEqual(isTabletTest2(), true)
...
deepStrictEqual(isComputerTest(), false)
...
delete require.cache[require.resolve('./isComputer')]
const isComputerTest2 = require('./isComputer')
deepStrictEqual(isComputerTest2(), true)
